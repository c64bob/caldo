...
`); err != nil {
	...
	if base.CalendarHref != "/cal/work/" || base.CurrentName != "Work" || base.CurrentVersion != 3 {
		t.Fatalf("unexpected base payload: %#v", base)
	}

	_, err = database.LoadProjectRenameBase(context.Background(), "project-1", 2, "Renamed")
...
`); err != nil {
	...
	if err := database.RenameProject(context.Background(), "project-1", 4, "Renamed Work"); err != nil {
