...
<d:response>
<d:propstat><d:prop><d:getetag>\"etag\"</d:getetag><cs:getctag>ctag</cs:getctag><c:calendar-home-set><d:href>/remote.php/dav/calendars/alice/</d:href></c:calendar-home-set></d:prop></d:propstat>
</d:response>
</d:multistatus>`))
	}))
