...
func (h *TasksHandler) HTMXSidebarLists(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		http.Error(w, "Listen konnten nicht geladen werden", http.StatusBadGateway)
		return
	}
	...
	if err := h.Templates.RenderSidebar(w, vm); err != nil {
